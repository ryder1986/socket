...
#include "Net_param.h"
#include "Net.h"
m_cam_context login_info[ACTIVE_CAM_NUM];
...
//	prt(info,"1");
    ...
    p_ctx->callback_fun(p_ctx->index,p_ctx->frame_data,p_ctx->frame_size);
...
//	IPCNET_Init();
	//	NET_IPC_Init();
	p->id = NET_IPC_Login(pDevIP, iDevPort, pszName, pszPassword); //闁跨喐鏋婚幏鐑芥晸閻偄灏呴幏鐑芥晸閸欘偅甯撮崠鈩冨閸撳秹鏁撻弬銈嗗闁跨喐鏋婚幏鐑芥晸闁惧府鎷�
	//lLoginID = IPCNET_Login(pDevIP, iDevPort, pszName, pszPassword); //闁跨喐鏋婚幏鐑芥晸閻偄灏呴幏鐑芥晸閸欘偅甯撮崠鈩冨閸撳秹鏁撻弬銈嗗闁跨喐鏋婚幏鐑芥晸闁惧府鎷�

//	S_REALDATA_INFO pRealDataInfo;
//	S_REALDATA_INFO pRealDataInfoTmp;
	S_REALPLAY_INFO pRealDataInfoTmp;
//	pRealDataInfo.lChannel = 0; /**< 闁岸鏁撻弬銈嗗闁跨喕鍓奸敐蹇斿闁跨喐鏋婚幏锟�0闁跨喐鏋婚幏宄邦潗 */
//	pRealDataInfo.lStreamMode = 2; /**< 闁跨喐鏋婚幏鐑芥晸閺傘倖瀚归柨鐔告灮閹风兘鏁撻柊纰夌秶閹凤拷0-闁跨喐鏋婚幏鐑芥晸閺傘倖瀚归柨鐔告灮閹风兘鏁撻弬銈嗗1-闁跨喐鏋婚幏鐑芥晸閺傘倖瀚归柨鐔告灮閹凤拷 ,2-MJPEG*/
//	pRealDataInfo.eEncodeType = VIDEO_MJPEG; //VIDEO_H264_MAJOR; /**< 闁跨喐鏋婚幏鐑芥晸閺傘倖瀚归柨鐔告灮閹风兘鏁撻弬銈嗗 */

//	IPCNET_StartRealData(lLoginID, &pRealDataInfo, NULL);

//	pRealDataInfoTmp.lChannel = 0; /**< 闁岸鏁撻弬銈嗗闁跨喕鍓奸敐蹇斿闁跨喐鏋婚幏锟�0闁跨喐鏋婚幏宄邦潗 */
//	pRealDataInfoTmp.lStreamMode = 1; /**< 闁跨喐鏋婚幏鐑芥晸閺傘倖瀚归柨鐔告灮閹风兘鏁撻柊纰夌秶閹凤拷0-闁跨喐鏋婚幏鐑芥晸閺傘倖瀚归柨鐔告灮閹风兘鏁撻弬銈嗗1-闁跨喐鏋婚幏鐑芥晸閺傘倖瀚归柨鐔告灮閹凤拷 ,2-MJPEG*/
//	pRealDataInfoTmp.eEncodeType = VIDEO_H264_MINOR; /**< 闁跨喐鏋婚幏鐑芥晸閺傘倖瀚归柨鐔告灮閹风兘鏁撻弬銈嗗 */
